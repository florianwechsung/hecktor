...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
        ...
        if num_outputs > 1:
            ...
            dense = Dense(units=num_outputs,
                          kernel_initializer="he_normal",
                          kernel_regularizer=l2(reg_factor))(dropout1)
            normalized = BatchNormalization()(dense)
            act = Activation('softmax')(normalized)
        else:
            dropout1 = Dropout(0.3)(flatten1)
            dense = Dense(units=num_outputs,
                          kernel_initializer="he_normal",
    ...
    @staticmethod
    def build_resnet_small(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 18."""
        return Resnet3DBuilder.build(input_shape, num_outputs, basic_block,
                                     [1, 1, 1, 0], reg_factor=reg_factor)
    @staticmethod
